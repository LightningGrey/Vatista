...
//#include "Mesh.h"
//
//void computeTangents(std::vector<Vatista::Vertex>& verts, std::vector<uint32_t>& indices,
...
//};
//
//void computeTangents(std::vector<Vatista::MorphVertex>& verts, std::vector<uint32_t>& indices,
//	std::vector<glm::vec3>& tangents, std::vector<glm::vec3> bitangents) {
//
//	for (int i = 0; i < verts.size(); i + 3) {
//		//face vertices
