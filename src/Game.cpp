...
void Vatista::Game::init()
{
	...
	//Character1 = std::make_shared<Z3n>();
	//Character2 = std::make_shared<Z3n>();
	//
	//Player1->bindCharacter(Character1);
	//Player2->bindCharacter(Character2);
	//
	//Player2->getCharacter()->setPos(glm::vec3(1.0f, 0.0f, 0.0f));
	//Player2->getCharacter()->setRotY(-90.f);
